...
public partial class Localizer(Project project, LangsData langsData)
{
    ...
    string GetDeclModuleName(Decl decl)
    {
    ...
    readonly string AutogenComment = "// This code is automatically generated by TeReoLocalizer, do not edit manually. Changes will be overriden.";
    ...
    string GenerateKeysMap(List<Decl> decls)
    {
