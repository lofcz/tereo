...
(function (OptionModes) {
    OptionModes[OptionModes["Single"] = 0] = "Single";
    OptionModes[OptionModes["Groups"] = 1] = "Groups";
})(OptionModes || (OptionModes = {}));
var SelectDesignTypes;
(function (SelectDesignTypes) {
    SelectDesignTypes[SelectDesignTypes["Unknown"] = 0] = "Unknown";
    SelectDesignTypes[SelectDesignTypes["Default"] = 1] = "Default";
    SelectDesignTypes[SelectDesignTypes["InlineDescription"] = 2] = "InlineDescription";
})(SelectDesignTypes || (SelectDesignTypes = {}));
var fullOptions = {
    id: "",
    options: [],
    multiple: false,
...
function PrepareData(pars = fullOptions) {
    var selectedOptions = [];
    var finalPars = [];
    var replaceAccent = (x) => x === null || x === undefined ? "" : x.toString().normalize("NFD").replace(/[\u0300-\u036f]/g, "");
        ...
        mcf.requireCss("virtual-select", () => {
            ...
            function initVselect() {
                ...
                if (pars.modalRef && pars.modalRef.length > 0) {
                    vselectConfig["dropboxWrapper"] = "body";
